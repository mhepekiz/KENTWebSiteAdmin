...
if($ac_t=="delete"){
	...
	$randevu_detay = mysql_query("select id, zaman, adsoyad, email, bolum, doktor, telefon, ceptelefon, tarihsaat, durum from online_randevu where id='$pro_d'");
	list($r_id, $r_zaman, $r_ad, $r_email, $r_bolum, $r_doktor, $r_tel, $r_gsm, $r_tsaat, $r_durum) = mysql_fetch_row($randevu_detay);
