...
<?
	...
	$polk_detay = mysql_query("select id, visible, aktiflink, poliklinik, detay from poliklinikler where id='$remhid'");
	list($po_id, $po_vis, $po_al, $po_ad, $po_detay) = mysql_fetch_row($polk_detay);
...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/poliklinik_edit.php" >
...
<tr>
      ...
      <td align="left">Poliklinik Sayfası</td>
		...
		if($po_vis=="yes"){ echo'<option selected value="yes">Evet</option>'; }
		if($po_vis=="no"){ echo'<option selected value="no">Hayır</option>'; }
...
<tr>
      ...
      <td align="left">Aktif Link</td>
		...
		if($po_al=="yes"){ echo'<option selected value="yes">Evet</option>'; }
		if($po_al=="no"){ echo'<option selected value="no">Hayır</option>'; }
...
<tr>
    ...
    <tr>
      ...
      <td width="100%"><input type="text" name="poliklinik" size="70" value="<?=$po_ad?>"></td>
    ...
    <tr valign="top">
      ...
      <td width="100%" colspan="2"><textarea class="ckeditor" cols="80" id="editor1" name="metin" rows="10"><?=$po_detay?></textarea>
</td>
