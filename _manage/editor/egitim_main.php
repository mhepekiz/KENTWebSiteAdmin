...
return $ayx;
		...
		$orderdate2 = "$ordy[2]-$ordy[1]-$ordy[0]";
			...
			mysql_query("insert into egitimler (baslik, detay, egitimbasla, egitimbitir, zaman, editor) values ('$baslik','$metin','$orderdate','$orderdate2','$zaman','$e_uname')")or die("DB Error");
...
$proc = "Egitim eklendi ($baslik)...";



echo "<script> alert(\"Egitim eklendi ($baslik)!\"); </script>";
