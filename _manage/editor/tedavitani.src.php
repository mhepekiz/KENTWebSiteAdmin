...
<legend>G&#246;rsel Ekleme Formu</legend>

<table width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td>

		
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/tedavitani.php" onSubmit="return bosvarmi(this)">
...
<legend>Sistemdeki G&#246;rseller</legend>
...
<table border="0" width="100%" id="table10" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<td nowrap width="100%" bgcolor="#FF6C00"><b>G&#246;rsel</b></td>
...
$get_prd = mysql_query("select id,resim1,zaman,editor from genelresim $newsq");
