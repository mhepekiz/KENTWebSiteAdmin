	...
	<script type="text/javascript" src="/crop/js/UvumiCrop-compressed.php?donus=ocak_main.php"> </script>
...
if($ac_t=="add"){
			...
			mysql_query("insert into ocaklar (kategori, foto_1, foto_2, foto_3) values ('$kategori','0','0','0')")or die("DB Error");
...
$ressim = resim($filename_name);
    ...
    if(!$error_upload){
	  echo"--------------$filename";
        ...
        // resize to 450 w
		  ...
		  $target_large = "$pitcure_path"."$u_id"."_ocak_large_"."$p_x"."-"."$ressim".".jpg";
        ...
        // resize to 70 w		  
		  ...
		  $target_detail = "$pitcure_path"."$u_id"."_ocak_detail_"."$p_x"."-"."$ressim".".jpg";
		  $THUMB_X_detail = 250;
        ...
        // resize to 100 w
		  ...
		  $target_home = "$pitcure_path"."$u_id"."_ocak_home_"."$p_x"."-"."$ressim".".jpg";
	...
	mysql_query("update ocaklar set foto_1='$home_sql_name', foto_2='$detail_sql_name', foto_3='$appcrop' where id='$urunum'") or die("DB Err");
...
$welcomefile=$docroot."/admin/_manage/editor/ocak_resim.src.php";
include($welcomefile);
