...
<legend>Sistemdeki Bannerlar</legend>
...
{
?>  
	<li id="editor_<?=$id?>"><img src="/_media/transfer_up_down.png" border="0" />&nbsp;&nbsp;<img src="<?=$editor?>" width="200" height="61" /></li>
<?
}
?>
</ul>
...
function liste_sirala()
{
	...
	new Ajax.Request('kayit2.php', options);
}
