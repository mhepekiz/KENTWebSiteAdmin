<?
			...
			$pol_alt = mysql_query("select poliklinik, baslik, detay from poliklinik_alt_en where id='$remhid'");
			list($po_id, $po_po, $po_det) = mysql_fetch_row($pol_alt);
			
				
				$poliad = mysql_query("select poliklinik from poliklinikler where id='$po_id'");
...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/add2pol_en_edit.php" >
...
<tr>
      ...
      <td width="90%"><input type="text" name="ekbaslik" size="70" value="<?=$po_po?>"></td>
    ...
    <tr valign="top">
      ...
      <td width="100%" colspan="2"><textarea class="ckeditor" cols="80" id="editor1" name="metin" rows="10"><?=$po_det?></textarea>
</td>
...
$hs = 0;
	...
	$get_polk = mysql_query("select id, poliklinik from poliklinikler where id='$po_id'");
	list($p_id, $p_pol) = mysql_fetch_row($get_polk);




$get_news = mysql_query("select id,baslik,editor,zaman from poliklinik_alt where poliklinik='$p_id' order by baslik");
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/add2pol_edit.php?ac_t=update&remhid='.$pid.'&mansetst='.$hmanset.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
	<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/haber_order.php"><img src="/admin/_media/online.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/add2pol.php"><img src="/admin/_media/sml_plus.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/add2pol.php?ac_t=del&remhidx='.$po_id.'&remhid='.$remhid.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
