...
<?
	...
	$get_pol = mysql_query("select id, poliklinik from poliklinikler where id='$remhid'");
...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/poliklinik_varyant.php" >
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
	...
	<tr>
        ...
        <td nowrap width="1" bgcolor="#FF6C00" align="center"><b>S</b></td>
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/poliklinik_varyant_edit.php?ac_t=update&remhid='.$pid.'&mansetst='.$hmanset.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/poliv_order.php?ac_t=addmore&remhid='.$pid.'"><img src="/admin/_media/online.gif" border="0"></a></td>
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/add2pol_en.php?ac_t=addmore&remhid='.$pid.'"><img src="/admin/_media/sml_plus.gif" border="0"></a></td>
