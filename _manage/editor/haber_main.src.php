...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/haber_main.php" >
  ...
  <tr>
    ...
    <tr>
      ...
      <td align="left">Biti&#351; Tarihi</td>

      <td width="100%"><script>DateInput('orderdate', true, 'DD-MON-YYYY')</script>
</td>

    </tr> 

<input type="hidden" name="bitis" value="" />
