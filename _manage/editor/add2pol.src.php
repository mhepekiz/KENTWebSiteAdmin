...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/add2pol.php" >
...
$get_news = mysql_query("select id,baslik,editor,zaman from poliklinik_alt where poliklinik='$remhid' order by baslik");
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/add2pol_edit.php?ac_t=update&remhid='.$pid.'&mansetst='.$hmanset.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
	<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/haber_order.php"><img src="/admin/_media/online.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/add2pol.php?ac_t=del&remhidx='.$pid.'&remhid='.$remhid.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
