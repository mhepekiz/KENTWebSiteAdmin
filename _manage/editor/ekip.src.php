...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/ekip.php" >
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/ekip_varyant.php?remhid='.$hid.'"><img src="/admin/_media/varyant.gif" border="0"></a></td>
