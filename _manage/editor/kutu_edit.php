...
if($ac_t=="upd"){
	...
	$link = mysql_real_escape_string($kutulink);
			...
			mysql_query("update kutular set lang='$dil', baslik='$baslik', aciklama='$aciklama', link='$link', zaman='$zaman', editor='$e_uname' where id='$remhid'")or die("DB Error");
...
$ressim = resim($filename_name);
  ...
  if($filename){
	...
	mysql_query("update kutular set resim='$home_sql_name' where id='$remhid'") or die("DB Err");
...
$welcomefile=$docroot."/admin/_manage/editor/kutu_edit.src.php";
include($welcomefile);
