<?
	...
	$kupur = mysql_query("select id, tarih, yayin, foto_1 from medya where id='$remhid'");
	list($kup_id, $kup_ta, $kup_yay, $kup_fo) = mysql_fetch_row($kupur);
...
<form id="myform" name="myform" class="fValidator-form"  method="POST" enctype="multipart/form-data" class="fValidator-form" action="/admin/_manage/editor/medya_edit.php" >
...
<tr>
      ...
      <td width="100%"><input type="text" name="yayin" size="70" value="<?=$kup_yay?>"></td>
...
<tr valign="top">  <td width="100%" colspan="2"><table width="100%" border="0" cellpadding="3">
 <tr>
  ...
  <input type="hidden" name="tarix" value="<?=$kup_ta?>">
