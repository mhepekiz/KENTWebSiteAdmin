...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/prosedur.php" >
...
<tr>
    ...
    <tr>
      ...
      <td width="100%"><input type="text" name="prosedur" size="70"></td>
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/prosedur_edit.php?ac_t=update&remhid='.$pid.'&mansetst='.$hmanset.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/prosedur.php?ac_t=del&remhid='.$pid.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
