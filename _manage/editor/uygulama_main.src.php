 ...
 <script type="text/javascript">
		exampleCropper1 = new uvumiCropper('example2',{
			coordinates:false,
			keepRatio:true,
			preview:false,
...
<form id="myform" name="myform" class="fValidator-form"  method="POST" enctype="multipart/form-data" class="fValidator-form" action="/admin/_manage/editor/uygulama_resim.php" >
  ...
  <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" cellpadding="5">
      ...
      <td valign="top" width="10%"><font face="Arial, Helvetica, sans-serif" style="font-size:12px">Uygulama Fotoğrafı</font></td>
