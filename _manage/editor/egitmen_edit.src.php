...
<legend>Egitmen Edit Formu</legend>

<table width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td>

		
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/egitmen_edit.php" >
...
<tr>
      ...
      <td width="100%"><input type="text" name="adsoyad" size="70" value="<?=$e_ad?>"></td>
    ...
    <tr valign="top">
      ...
      <td width="100%" colspan="2"><textarea class="ckeditor" cols="80" id="editor1" name="metin" rows="10"><?=$e_ozgecmis?></textarea>
</td>
...
$get_news = mysql_query("select id,adsoyad,editor,zaman from egitmenler $newsq");
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/egitmen_edit.php?ac_t=update&remhid='.$hid.'&mansetst='.$hmanset.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
	<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/egitmen_order.php"><img src="/admin/_media/online.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/egitmen_main.php?ac_t=del&remhid='.$hid.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
