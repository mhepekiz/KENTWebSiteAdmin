...
<?
	...
	$doktorum = mysql_query("select doktorid,lang, adsoyad,pozisyon, ozgecmis from ekip_varyant where id='$remhid'");
	list($dr_id, $dr_lang,$dr_ad, $dr_pozisyon, $dr_ozgecmis) = mysql_fetch_row($doktorum);
	
	
	
	
			$doktorad = mysql_query("select adsoyad from ekip where id='$dr_id'");
			list($dokad) = mysql_fetch_row($doktorad);
...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/ekip_varyant_edit.php" >
...
<tr>
    ...
    <tr>
      ...
      <td width="100%"><input type="text" name="adsoyad" size="70" value="<?=$dr_ad?>"></td>
...
<tr>
      ...
      <td width="90%"><input type="text" name="pozisyon" size="70" value="<?=$dr_pozisyon?>"></td>
    ...
    <tr valign="top">
      ...
      <td width="100%" colspan="2"><textarea class="ckeditor" cols="80" id="editor1" name="metin" rows="10"><?=$dr_ozgecmis?></textarea>
</td>
...
$newsq = "where doktorid='$dr_id' order by id desc limit 25";
...
<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/ekip_varyant_edit.php?ac_t=update&remhid='.$hid.'&mansetst='.$hmanset.'"><img src="/admin/_media/edit.gif" border="0"></a></td>
		...
		<td bgcolor="'.$bgc.'" nowrap align="center"><a href="/admin/_manage/editor/ekip_varyant.php?ac_t=del&remhid='.$dr_id.'&remhidx='.$hid.'"><img src="/admin/_media/delete.gif" border="0"></a></td> 
	</tr>'; 
