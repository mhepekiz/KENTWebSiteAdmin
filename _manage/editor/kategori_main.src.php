...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/kategori_main.php">
  ...
  <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td align="left" width="10%">Kategori TR</td>

      <td width="1%"><input type="text" name="kategoritr" size="70"></td>  <td width="90%">&nbsp;</td>
  ...
  <tr>
      ...
      <td align="left" width="10%">Kategori EN</td>

      <td width="1%"><input type="text" name="kategorien" size="70"></td>  <td width="90%"><input type="submit" value="Ekle" name="B1"></td>
...
<table border="0" width="100%" id="table10" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<form method="POST" action="/admin/_manage/editor/kategori_main.php" name="haber_ara">
...
$get_cat = mysql_query("select id,catof,kategori,kategorien,zaman from kategori $newsq");

while(list($kid,$katof,$kat,$katen,$kzam)=mysql_fetch_row($get_cat)){
...
echo'	<tr>
		...
		<td bgcolor="'.$bgc.'" nowrap width="100%">';  if($katof=="0"){ echo'*&nbsp;'; } echo''.$kat.' - '.$katen.'</td>
