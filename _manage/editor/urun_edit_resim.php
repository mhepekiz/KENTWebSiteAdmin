	...
	<script type="text/javascript" src="/crop/js/UvumiCrop-compressed.php?donus=urun_main.php"> </script>
...
if($ac_t=="update"){
			...
			$detay2 = stripslashes($detay2);
			mysql_query("update urunler set kategori='$kategori', lang='$lang', urunadi='$urunadi', ozellikler='$detay', tablo='$detay2' where id='$urunx'")or die("DB Error");
...
$pitcure_folder = "/_all_media/_products/";
  ...
  if($filename){
	...
	mysql_query("update urunler set foto_1='$home_sql_name', foto_2='$detail_sql_name', foto_3='$large_sql_name' where id='$urunx'") or die("DB Err");
...
window.location.href="/admin/_manage/"
</script>
...
$welcomefile=$docroot."/admin/_manage/editor/urun_edit_resim.src.php";
include($welcomefile);
