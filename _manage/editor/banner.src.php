...
<legend>Banner Ekleme Formu</legend>

<table width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td>

		
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/banner.php" onSubmit="return bosvarmi(this)">
...
$get_prd = mysql_query("select id,banner,zaman,editor from banner $newsq");
