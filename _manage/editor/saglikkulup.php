...
if($ac_t=="delete"){
	...
	list($r_id, $r_sira, $r_zaman, $r_ad, $r_email, $r_bolum, $r_doktor, $r_tel, $r_gsm, $r_tsaat, $r_durum) = mysql_fetch_row($randevu_detay);
...
$welcomefile=$docroot."/admin/_manage/editor/saglikkulup.src.php";
include($welcomefile);
