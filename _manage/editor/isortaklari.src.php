...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/isortaklari.php" onSubmit="return bosvarmi(this)">
...
$get_prd = mysql_query("select id,banner,zaman,editor from ortakbanner $newsq");
