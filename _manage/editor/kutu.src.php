...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/kutu.php" >
...
<tr>
      ...
      <td width="100%"><input type="text" name="kutubaslik" size="70"></td>
    ...
    <tr>
      ...
      <td width="100%"><input type="text" name="aciklama" size="70"></td>
    ...
    <tr>
      ...
      <td width="100%"><input type="text" name="kutulink" size="70"></td>
