<?
			...
			$pol_alt = mysql_query("select poliklinik, baslik, detay from poliklinik_alt where id='$remhid'");
...
<form name="birseyekle" method="POST" enctype="multipart/form-data" action="/admin/_manage/editor/add2pol_edit.php" >
